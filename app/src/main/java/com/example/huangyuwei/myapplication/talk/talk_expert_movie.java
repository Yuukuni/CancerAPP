...
public class talk_expert_movie extends AppCompatActivity {
    ...
    private talk_expert_movie.myWebChromeClient xwebchromeclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talk_expert_movie);
        ...
        mWebView.loadUrl("https://www.youtube.com/watch?v=uKTn88nLWD4&list=PLcYwYvFNfjqZ1K_StNZHnvvcpA-_XvFiX&index=1");
