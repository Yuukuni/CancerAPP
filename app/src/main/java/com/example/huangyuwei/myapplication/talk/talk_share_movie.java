...
public class talk_share_movie extends AppCompatActivity {
    ...
    private talk_share_movie.myWebChromeClient xwebchromeclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talk_share_movie);
